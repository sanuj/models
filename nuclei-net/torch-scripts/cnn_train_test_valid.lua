...
cmd:option('--loadModelPath', '/home/test/Projects/models/train_701_val_734.dat', 'path from where to load model.')
cmd:text()
...
if opt.convertData then
	nuclei_train = torch.load('/home/test/Projects/nuclei-net-data/TCGA-data/train_new.t7')
	nuclei_valid = torch.load('/home/test/Projects/nuclei-net-data/TCGA-data/valid_new.t7')
